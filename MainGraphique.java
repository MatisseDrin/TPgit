...
try {
    if(p.estEchec('B')){
        ...
        f.ajouter(new Texte(Couleur.ROUGE, "Roi blanc échec", new Font("Calibri", Font.TYPE1_FONT, 40), new Point(MainGraphique.tailleCase * 4, (int)(MainGraphique.tailleCase * 8.5))));
    }
} catch (RoiNonTrouveException e) {
    System.out.println("Erreur : Roi blanc introuvable - " + e.getMessage());
}
...
try {
    if(p.estEchec('N')){
        ...
        f.ajouter(new Texte(Couleur.ROUGE, "Roi noir échec", new Font("Calibri", Font.TYPE1_FONT, 40), new Point(MainGraphique.tailleCase * 4, (int)(MainGraphique.tailleCase * 8.5))));
    }
} catch (RoiNonTrouveException e) {
    System.out.println("Erreur : Roi noir introuvable - " + e.getMessage());
}
}
