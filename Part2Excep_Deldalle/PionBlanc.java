...
class PionBlanc extends Pion{
    ...
    public PionBlanc()throws CouleurPieceException, ErreurCoordonneesException{
	super('B', new Position());
    }

    public PionBlanc(Position position) throws CouleurPieceException, ErreurCoordonneesException{
	super('B', position);
    }
