...
class PionNoir extends Pion{
    ...
    public PionNoir() throws CouleurPieceException, ErreurCoordonneesException{
	super('N', new Position());
    }

    public PionNoir(Position position) throws CouleurPieceException, ErreurCoordonneesException{
	super('N', position);
    }
