...
class Fou extends Piece{
    ...
    public Fou() throws CouleurPieceException, ErreurCoordonneesException{
	super('B', new Position());
    }

    public Fou(char couleur, Position position) throws CouleurPieceException, ErreurCoordonneesException{
