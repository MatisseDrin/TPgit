...
abstract class Piece {
    ...
    public Piece(char couleur, Position position) throws CouleurPieceException, ErreurCoordonneesException {
    ...
    public Piece(char couleur, int x, int y) throws CouleurPieceException, ErreurCoordonneesException {
        this(couleur, new Position(x, y));
    }

    public Piece(char couleur, String position) throws CouleurPieceException, ErreurCoordonneesException {
