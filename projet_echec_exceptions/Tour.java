...
class Tour extends Piece{
    ...
    public Tour() throws CouleurPieceException, ErreurCoordonneesException{
	super('B', new Position());
    }

    public Tour(char couleur, Position position) throws CouleurPieceException, ErreurCoordonneesException{
